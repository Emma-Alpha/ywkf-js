import type { TransformOptions as EsbuildOpts } from '@4399ywkf/bundler-utils/compiled/esbuild';
// @ts-ignore
import CSSMinimizerWebpackPlugin from '@4399ywkf/bundler-webpack/compiled/css-minimizer-webpack-plugin';
import TerserPlugin, {
  type TerserOptions,
